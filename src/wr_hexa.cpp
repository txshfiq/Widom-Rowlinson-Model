...
// M = # of species
// a = height of honeycomb lattice
// b = width of honeycomb lattice
// brick wall style projection
// z = fugacity (absolute activity) -> constant value, same chemical potential throughout (grand-canonical ensemble)

const int a = 20; // a is even  AND  a >= 2
const int b = 21; // b is odd  AND  b >= 3
const int M = 2;
const double z = 10;
